...
namespace ProductCatalog.Models
{
	...
	public class Category
	{
		public int Id { get; set; }
		public string Name { get; set; }
		public ConcurrentList<Product> Products { get; set; }

		private static int CompareProducts(Product a, Product b) => (a.Id - b.Id);

		public Category() {
			Products = new ConcurrentList<Product>(CompareProducts);
		}
	...
	{
		public ConcurrentList<Category> Categories { get; set; }
		...
		private static int CompareCategories(Category a, Category b) => (a.Id - b.Id);

		private Catalog() {
			Categories = new ConcurrentList<Category>(CompareCategories);
			AddTestData();
		}
